...
CreateDashboard creates a dashboard for the users to put in their trip requirements.
Source location
Trip start date
Trip end date
Type of trip
...
TripPlanner creates day-wise itineraries for each day of the trip for the suggested top three trip locations based on user needs fed in the user dashboard created by CreateDashboard.
